...
`StoreNodeRequest` → `StoreNodeResponse`
...
|---|---|---|---|
| `work_id` | 1 | `string` | — |
| `node` | 2 | `gibson.graphrag.v1.GraphNode` | — |
...
|---|---|---|---|
| `work_id` | 1 | `string` | — |
| `finding` | 2 | `bytes` | finding is the serialized finding payload (proto-encoded Finding message). |
